...
export function PageHeader({ title, subtitle, actions }: { title: string; subtitle?: string; actions?: React.ReactNode }) {
  return (
    <div className="mb-6 overflow-hidden rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-premium backdrop-blur-xl dark:border-white/10 dark:bg-navy-800/80 md:p-6">
